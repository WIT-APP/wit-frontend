...
import InputSelectCountry from "../components/ui/InputSelectCountry";
          ...
          <div className="">
            ...
            <InputSelect
              ...
              options={[
                ...
                {
                  value: "Automatización de Tecnologías de la Información con Python",
                  label: "Automatización de Tecnologías de la Información con Python",
                },
              ]}
              onChange={handleSelectChange} value={""}            />
            <InputCheckbox
              ...
              options={[
                {
                  ...
                  label: "Estoy interesada/o en formarme en competencias tecnológicas",
                },
                {
                  value: "Estoy interesada/o en obtener un empleo del sector tecnológico",
                  label: "Estoy interesada/o en obtener un empleo del sector tecnológico",
                },
                {
            ...
            <InputSelect
              ...
              options={[
                ...
                {
                  value: "Acceso muy limitado (tengo dispositivo pero no tengo internet)",
                  label: "Acceso muy limitado (tengo dispositivo pero no tengo internet)",
                },
                {
                  value: "Acceso limitado (tengo dispositivo e internet limitado)",
                  label: "Acceso limitado (tengo dispositivo e internet limitado)",
                },
                {
                  value: "Acesso medio (tengo dispositivo e internet de baja calidad)",
                  label: "Acesso medio (tengo dispositivo e internet de baja calidad)",
                },
                {
                  value: "Buen acceso (tengo buena conexion a internet y dispositivo)",
                  label: "Buen acceso (tengo buena conexion a internet y dispositivo)",
                },
              ]}
              onChange={handleSelectChange} value={""}            />
            <InputSelect
              ...
              onChange={handleSelectBooleanChange} value={""}            />
            <InputTextarea
